...
function Create_Body()
{
   ...
   //add_js("Code/js/Tracking_Subjects.js");
    ...
    // Fathers
    var father1 = Create_Link(1, true, 'null', 'bar0_5','אינטראקציות');
    var father2 = Create_Link(1, true, 'null', 'bar6_13','תוספות');
    ...
    ul_Son1.appendChild(Create_Link(2, false, 'a0', 'bar0_0','תפריט נפתח'));
    ul_Son1.appendChild(Create_Link(2, false, 'a1', 'bar1_1',' גרירה'));
    ul_Son1.appendChild(Create_Link(2, false, 'a2', 'bar2_2',' תיבות טקסט'));
    ul_Son1.appendChild(Create_Link(2, false, 'a3', 'bar3_3',' שאלות אמריקאיות'));
    ul_Son1.appendChild(Create_Link(2, false, 'a4', 'bar4_4',' תזוזה תכנותית'));
    ul_Son1.appendChild(Create_Link(2, false, 'a5', 'bar5_5',' מקשי מקלדת'));
    
    
    ul_Son2.appendChild(Create_Link(2, false, 'a6', 'bar6_6',' הוספת קישור ללומדה'));
    ul_Son2.appendChild(Create_Link(2, false, 'a7', 'bar7_7',' טיימר'));
    ul_Son2.appendChild(Create_Link(2, false, 'a8', 'bar8_8',' הרחבות'));
    ul_Son2.appendChild(Create_Link(2, false, 'a9', 'bar9_9',' שינוי גודל האובייקטים'));
    ul_Son2.appendChild(Create_Link(2, false, 'a10', 'bar10_10',' סאונד'));
    ul_Son2.appendChild(Create_Link(2, false, 'a11', 'bar11_11',' הפעלת סרטון מנקודה מסוימת'));
    ul_Son2.appendChild(Create_Link(2, false, 'a12', 'bar12_12',' ZOOM'));
    ul_Son2.appendChild(Create_Link(2, false, 'a13', 'bar13_13',' גלריית תמונות'));
   ...
   father2.appendChild(ul_Son2);
    ...
    Credits_Link.href="Screens/Credits_Ver.3.2.html";
...
function HandleEvent(e)
{
   ...
   // console.log("HNDELE EVENT= "+e.data);
    ...
    {
        window.location = "Screens/Credits_Ver.3.2.html";
    }
}
